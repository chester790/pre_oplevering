...
<body class="sub_page">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="userDropdown">
                ...
                if (isset($_SESSION['email'])) {
                  echo '<a class="dropdown-item" href="profile.html">Profile</a>';
      ...
      <div class="row">
        <div class="col-md-5 mx-auto">
          <div class="form_container">
            ...
            <form action="offerte-aanvraag.php" method="post" enctype="multipart/form-data">
              <div class="form-row">
              ...
              <div class="form-row">
                <div class="form-group col">
                  <input required name="companyname" type="text" class="form-control" placeholder="Uw bedrijfsnaam" max="100" min="1" />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col">
                  <input required name="street" type="text" class="form-control" placeholder="Uw straatnaam en huisnummer" max="100" min="1"/>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col">
                  <input required name="postcode" type="text" class="form-control" placeholder="Uw postcode" max="100" min="1"/>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col">
                  <input required name="plaats" type="text" class="form-control" placeholder="Uw plaats" max="100" min="1"/>
                </div>
              </div>
              <div class="form-row">
              ...
              <div class="form-row">
                <div class="form-group col">
                  <input type="text" name="reference" class="form-control" placeholder="Uw referentie" max="100" min="1" />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col">
                  <!-- <input type="text" name="projectdetails" class="message-box form-control" placeholder="Projectomschrijving" max="1000" min="1" /> -->
                  <textarea class="message-box form-control" rows="2" cols="50" name="projectdetails" placeholder="Projectomschrijving" wrap="hard" max="1000" min="1"></textarea>
                </div>
              </div>
              <div class ="form-row">
                <div class="form-group col">
  ...
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $projectdetails = isset($_POST['projectdetails']) ? $_POST['projectdetails'] : '';
      ...
      try {
          ...
          $mail->Subject = 'Offerteaanvraag gedaan door ' . $companyname;
          $mail->Body = 
